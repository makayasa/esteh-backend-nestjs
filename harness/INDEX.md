...
| --- | --- | --- | --- | --- |
| 0 | blocked | [Adaptasi harness MyXL ke Esteh](features/harness-bootstrap.json) | main | 1 |
| 10 | passing | [P0 — Aplikasi Bisa Running Lokal](features/p0-local-runtime.json) | main | 2 |
| 11 | blocked | [P1 — Fondasi Kontrak dan Konsistensi](features/p1-foundation.json) | — | 1 |
| 12 | passing | [GitHub #3 — Bootstrap admin dan login aman](features/issue-03-login.json) | main | 1 |
| 12 | blocked | [P2 — Identitas, Role, dan Session](features/p2-identity.json) | — | 2 |
| 13 | passing | [GitHub #4 — Expiry session dan logout](features/issue-04-session.json) | main | 1 |
| 13 | blocked | [P3 — Katalog Produk dan Bahan](features/p3-catalog.json) | — | 2 |
| 14 | passing | [GitHub #5 — Kelola akun](features/issue-05-accounts.json) | main | 1 |
| 14 | blocked | [P4 — Penjualan Tunai End-to-End](features/p4-cash-sales.json) | main | 1 |
...
| 19 | not_started | [P9 — Verifikasi dan Handoff Frontend](features/p9-integration-handoff.json) | — | 0 |
